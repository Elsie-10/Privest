...
export const portfolioService = {
   ...
   * Now async — this calls the FastAPI Portfolio Engine
   * (POST /api/portfolio/metrics) instead of running the calculation
   * in-browser. Raw transactions leave the browser at this step; see
   * root README "Architecture & privacy" for the trade-off this replaced.
   */
  async analyze(statement: ParsedStatement): Promise<PortfolioMetrics> {
