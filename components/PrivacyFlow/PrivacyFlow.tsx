  ...
  return (
    <div className="max-w-[560px] mx-auto px-10 py-32 text-center">
      ...
      <p className="text-grey text-[13.5px] mb-9">
        Your statement is analyzed by Privest&apos;s Python engine and only computed
        results are stored — this animation represents the confidential-compute
        design the transport is intended to run over.
      </p>
      ...
      <p className="mt-9 text-[11.5px] text-grey leading-relaxed">
        ...
        integration, built for demo purposes. In this build, your parsed transactions are sent to
        Privest&apos;s Python backend to compute your metrics, then discarded from memory — they
        are only persisted to the database if you save this analysis to your history.
      </p>
    </div>
  );
}
