...
export default function DashboardView({
  ...
  return (
    <div>
      <div className="mb-6">
        <h2 className="text-2xl font-display font-semibold">Portfolio dashboard</h2>
        <p className="text-[13.5px] text-grey mt-1">
          {metrics.transactionCount} transactions analyzed · {metrics.monthsOfActivity} month(s) of
          activity
        </p>
      </div>
